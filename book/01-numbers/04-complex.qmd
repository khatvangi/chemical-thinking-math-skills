...
<div style="margin-bottom:0.6rem;">
  <label>phase difference φ <input type="range" id="wiPhi" min="0" max="360" value="0" step="5"></label>
</div>
<canvas id="wiCanvas" width="660" height="320"></canvas>
<div class="widget-readout" id="wiReadout"></div>
:::
::: {.widget-debrief}
...
<script src="../js/widgets/wave-interference.js"></script>
