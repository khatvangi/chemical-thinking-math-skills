...
::: {.widget-frame}
::: {.widget-predict}
Run <em>rotation 90°</em> and watch only the det readout: predict its value throughout the whole motion. Then run <em>shear</em> — the square leans hard; predict the final determinant before the animation ends.
:::
::: {.widget-body}
