...
<section class="prose-section" id="opening">
...
<section class="prose-section" id="first-distinction">
...
<section class="prose-section" id="body">
...
<section class="prose-section" id="stillness">
...
<section class="prose-section" id="circle">
...
<section class="prose-section" id="sphere">
...
<section class="prose-section" id="relation">
...
<section class="prose-section" id="comparing">
...
<section class="prose-section" id="magnitude">
...
<section class="prose-section" id="gradient">
...
<section class="prose-section" id="causation">
...
<section class="prose-section" id="formalize">
...
<section class="prose-section" id="bridge">
...
<p class="closing-statement">We're just giving names to what you already see.</p>
</div>

<a href="04-direction.qmd" class="next-button">
